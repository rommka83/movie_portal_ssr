...
const filters = createSlice({
  ...
  reducers: {
    ...
    addInputRangeFilter(
      state,
      action: PayloadAction<{ type: 'rating' | 'votes'; value: number }>
    ) {
...
export const pendingPersonsSelector = (state: RootState) =>
  state.filters.personsPending;
export const getSelectedFilterSelector =
  (type: FilterType, t: TFunction) => (state: RootState) => {
